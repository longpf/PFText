...
+ (UIImage *)pf_animatedGIFWithData:(NSData *)data {
    ...
    if (count <= 1) {
        ...
        for (size_t i = 0; i < count; i++) {
            ...
            duration += [self pf_frameDurationAtIndex:i source:source];
...
+ (float)pf_frameDurationAtIndex:(NSUInteger)index source:(CGImageSourceRef)source {
...
- (BOOL)_isGIF {
    return (self.images != nil && self.duration > 0);
}
